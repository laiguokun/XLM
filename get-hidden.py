...
from src.evaluation.trans import TRANS_h
...
trans.get_hidden(os.path.join(data_root, 'valid.large.en.pth'), 'en')
trans.get_hidden(os.path.join(data_root, 'valid.large.de.pth'), 'de')
